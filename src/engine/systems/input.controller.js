...
class InputController {
    ...
    #storageUpgradeWrap = document.getElementById("storage-upgrade-wrap");
    ...
    #setBaseListeners() {
        ...
        this.addEventListener(this.#storageUpgradeWrap, 'click', () => EventBus.emit(Events.storageUpgrade.onClick));
    }
